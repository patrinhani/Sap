...
def execute(session, matriculas, periodo, options, base_path):
    print("--- Iniciando execução de HP ---")
    try:
    ...
    try:
        ...
        grid.setCurrentCell(7, "TEXT"); grid.selectedRows = "7"
        ...
        return True, "Processo HP concluído."
    except Exception as e: return False, f"Erro em HP: {e}"