    ...
    try:
        while True:
            ...
            if msg["type"] == "status":
                ...
                detalhe_status_var.set(msg["msg"][:100] + "...") # Mostra parte do erro
...
btn = ttk.Button(plr_frame, text="Executar PLRs (Completo)", command=lambda: start_automation("PLRs"), bootstyle="primary"); btn.grid(row=0, column=0, columnspan=2, sticky=EW, pady=(0,5)); all_buttons.append(btn)
